...
for pos = 0:5
    ...
    for symbolIdx = symbolStartIdx + 1 : symbolStartIdx + numSrsSymbols
        ...
        [channel_freq_response, ~] = CIRs(tx_position, rx_position, scenario, rx_mov(3));                  % Channel impulse response modeled in QuaDriGa of size 3276 x N, where is N no. of gNbs's
